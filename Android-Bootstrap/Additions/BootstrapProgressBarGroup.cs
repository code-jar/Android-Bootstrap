...
{
    public partial class BootstrapProgressBarGroup
    {
        static IntPtr id_setOrientation_I;
        // Metadata.xml XPath method reference: path="/api/package[@name='com.beardedhen.androidbootstrap']/class[@name='BootstrapProgressBarGroup']/method[@name='setOrientation' and count(parameter)=1 and parameter[1][@type='int']]"
